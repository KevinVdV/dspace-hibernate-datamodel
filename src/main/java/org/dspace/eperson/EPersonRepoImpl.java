 ...
 * @version $Revision$
 */
public class EPersonRepoImpl extends DSpaceObjectRepoImpl<EPerson> implements EPersonRepo
{
    ...
    /** log4j logger */
    private static Logger log = Logger.getLogger(EPersonRepoImpl.class);

    private EPersonDAO ePersonDAO = new EPersonDAOImpl();

    public EPersonRepoImpl()
    {
    }
...
*/
    ...
    private static int cmdAdd(Context context, String[] argv)
    {
        ...
        EPersonRepo epersonManager = new EPersonRepoImpl();
        try {
