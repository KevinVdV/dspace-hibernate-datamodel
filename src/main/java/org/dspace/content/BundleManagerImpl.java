 ...
 * @version $Revision$
 */
public class BundleManagerImpl extends DSpaceObjectManagerImpl<Bundle> implements BundleManager
{
    /** log4j logger */
            ...
            IOException, SQLException
    {
        ...
        Bitstream b = bitstreamManager.create(context, is);
        ...
        throws AuthorizeException, IOException, SQLException
    {
        ...
        Bitstream b = bitstreamManager.register(context, assetstore, bitstreamPath);
            ...
            AuthorizeException
    {
        ...
        bitstreamManager.update(context, b);
    }
    ...
    public void setOrder(Context context, Bundle bundle, int bitstreamIds[]) throws AuthorizeException, SQLException {
        ...
        for (int i = 0; i < bitstreamIds.length; i++) {
            ...
            Bitstream bitstream = bitstreamManager.find(context, bitstreamId);
            if(bitstream == null){
