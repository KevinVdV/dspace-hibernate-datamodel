 ...
 * @version $Revision$
 */
public class BitstreamManagerImpl extends DSpaceObjectManagerImpl<Bitstream> implements BitstreamManager
{
    /** log4j logger */
    ...
    public void setFormat(Context context, Bitstream bitstream, BitstreamFormat f) throws SQLException
    {
        ...
        {
            // Use "Unknown" format
            f = bitstreamFormatManager.findUnknown(context);
        }
