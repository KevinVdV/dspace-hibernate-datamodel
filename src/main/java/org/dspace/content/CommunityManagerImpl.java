 ...
 * @version $Revision$
 */
public class CommunityManagerImpl extends DSpaceObjectManagerImpl<Community> implements CommunityManager
{
    /** log4j category */
...
//        clearDetails();
            ...
            IOException, SQLException
    {
        ...
        if (community.getLogo() != null)
        {
            ...
            bitstreamManager.delete(context, community.getLogo());
        }
            ...
            AuthorizeException, IOException
    {
        ...
        if(CollectionUtils.isEmpty(c.getCommunities())){
            collectionManager.delete(context, c);
        }
