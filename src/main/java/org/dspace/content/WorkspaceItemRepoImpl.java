 ...
 * @version $Revision$
 */
public class WorkspaceItemRepoImpl implements WorkspaceItemRepo
{
    /** log4j logger */
    ...
    public WorkspaceItem create(Context c, Collection coll, boolean template) throws AuthorizeException, SQLException,
        ...
        // Create an item
        Item i = new ItemRepoImpl().create(c, workspaceItem);
        ...
        {
            List<MetadataValue> md = itemDAO.getMetadata(templateItem, Item.ANY, Item.ANY, Item.ANY, Item.ANY);
