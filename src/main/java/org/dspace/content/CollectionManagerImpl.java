 ...
 * @version $Revision$
 */
public class CollectionManagerImpl extends DSpaceObjectManagerImpl<Collection> implements CollectionManager
{
    /** log4j category */
            ...
            AuthorizeException
    {
        ...
        communityManager.addCollection(context, community, newCollection);
        ...
        // of 'anonymous' READ
        Group anonymousGroup = groupManager.find(context, 0);
            ...
            IOException, SQLException
    {
        ...
        {
            bitstreamManager.delete(context, collection.getLogo());
        }
        ...
        {
            Bitstream newLogo = bitstreamManager.create(context, is);
    ...
    public Group createSubmitters(Context context, Collection collection) throws SQLException, AuthorizeException
    {
        ...
        if (submitters == null)
        {
            ...
            context.turnOffAuthorisationSystem();
            submitters = groupManager.create(context);
            context.restoreAuthSystemState();

            submitters.setName("COLLECTION_" + collection.getID() + "_SUBMIT");
            groupManager.update(context, submitters);
    ...
    public Group createAdministrators(Context context, Collection collection) throws SQLException, AuthorizeException
    {
        ...
        if (admins == null)
        {
            ...
            context.turnOffAuthorisationSystem();
            admins = groupManager.create(context);
            context.restoreAuthSystemState();

            admins.setName("COLLECTION_" + collection.getID() + "_ADMIN");
            groupManager.update(context, admins);
        }
    ...
    public Item createTemplateItem(Context context, Collection collection) throws SQLException, AuthorizeException
    {
        ...
        {
            Item template = itemManager.createTemplateItem(context, collection);
            ...
            IOException
    {
        ...
        if (template != null)
        {
            ...
            context.turnOffAuthorisationSystem();
            itemManager.delete(context, template);
            context.restoreAuthSystemState();
...
//                getID());
        ...
        while (items.hasNext())
        {
            ...
            if (itemManager.isOwningCollection(item, collection))
            {
...
*/
    ...
    public void move(Context context, Item item, Collection from, Collection to, boolean inheritDefaultPolicies) throws SQLException, AuthorizeException, IOException
    {
        ...
        if (!itemManager.canEdit(context, item))
        {
        ...
        if (itemManager.isOwningCollection(item, from))
        {
            ...
            if (inheritDefaultPolicies)
            {
                ...
                itemManager.inheritCollectionDefaultPolicies(context, item, to);
            }
