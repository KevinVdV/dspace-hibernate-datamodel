...
//        handle = HandleManager.findHandle(context, this);
            ...
            AuthorizeException
    {
        ...
        Bundle b = bundleDAO.create(context);
        b.setName(name);
    ...
    public void removeBundle(Context context, Item item, Bundle b) throws SQLException, AuthorizeException, IOException {
     ...
     protected void deleteBundle(Context context, Item item, Bundle b) throws AuthorizeException, SQLException, IOException {
        ...
        new BundleRepoImpl().delete(context, b);
            ...
            throws AuthorizeException, IOException, SQLException
    {
        ...
        Bitstream bitstream = new BundleRepoImpl().createBitstream(context, bnd, is);
...
*/
    ...
    */
    ...
    public void move (Context context, Item item, Collection from, Collection to, boolean inheritDefaultPolicies) throws SQLException, AuthorizeException, IOException
    {
        ...
        CollectionRepoImpl collectionRepo = new CollectionRepoImpl();
        collectionRepo.addItem(context, to, item);
        collectionRepo.removeItem(context, from, item);
