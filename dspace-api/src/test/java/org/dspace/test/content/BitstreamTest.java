...
public class BitstreamTest extends AbstractDSpaceObjectTest
{
     ...
     */
    @Test
    public void testCreate() throws IOException, SQLException, AuthorizeException {
        File f = new File(testProps.get("test.bitstream").toString());
    ...
    public void testGetHandle() throws SQLException {
        ...
        assertThat("testGetHandle 0", bs.getHandle(context), nullValue());
    }
    ...
    public void testExpungeNoDelete() throws SQLException, AuthorizeException {
        //stored in store 0 by default
        assertNotNull(bs);
        new NonStrictExpectations(authorizeService.getClass())
        {
        ...
        bitstreamService.expunge(context, bs);
    }

    @Test
    public void testExpungeDelete() throws SQLException, AuthorizeException {
        //stored in store 0 by default
        assertNotNull(bs);
        new NonStrictExpectations(authorizeService.getClass())
        {
        ...
        bitstreamService.delete(context, bs);
        bitstreamService.expunge(context, bs);
        assertNull(bitstreamService.find(context, bs.getID()));
    }
