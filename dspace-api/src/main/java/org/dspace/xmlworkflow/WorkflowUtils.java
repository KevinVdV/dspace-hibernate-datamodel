...
public class WorkflowUtils extends Util{
    ...
    public static HashMap<String, Role> getCollectionRoles(Workflow workflow, Collection thisCollection) throws IOException, WorkflowConfigurationException {
    ...
    public static HashMap<String, Role> getCollectionAndRepositoryRoles(Workflow workflow, Collection thisCollection) throws IOException, WorkflowConfigurationException {
        LinkedHashMap<String, Role> result = new LinkedHashMap<String, Role>();
        if(workflow != null){
            //Make sure we find one
            HashMap<String, Role> allRoles = workflow.getRoles();
    ...
    public static HashMap<String, Role> getAllExternalRoles(Workflow workflow, Collection thisCollection) throws IOException, WorkflowConfigurationException {
        LinkedHashMap<String, Role> result = new LinkedHashMap<String, Role>();
        if(workflow != null){
            //Make sure we find one
            HashMap<String, Role> allRoles = workflow.getRoles();
