...
public interface RequestInterceptor extends OrderedService {
     ...
     * then throw a {@link org.dspace.services.model.RequestInterceptor.RequestInterruptionException}.
     * 
     * @param requestId the unique id of the request
     * @param session the session associated with this request
     * @throws org.dspace.services.model.RequestInterceptor.RequestInterruptionException if this interceptor wants to stop the request
     */
